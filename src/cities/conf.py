...
country_codes = [
    ...
    'QA',
    'RE', 'RO', 'RS', 'RU', 'RW',
    'SA', 'SB', 'SC', 'SD', 'SS', 'SE', 'SG', 'SH', 'SI', 'SJ', 'SK', 'SL', 'SM', 'SN', 'SO', 'SR', 'ST', 'SV', 'SX',
    'SY', 'SZ',
...
if hasattr(django_settings, 'CITIES_IGNORE_EMPTY_REGIONS'):
    raise Exception("CITIES_IGNORE_EMPTY_REGIONS was ambiguous and has been moved to "
                    "CITIES_SKIP_CITIES_WITH_EMPTY_REGIONS")
