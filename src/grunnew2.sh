...
DJANGODIR=/home/ubuntu/raisin/repo2/src/                   # Django project directory
VIRTUAL_ENV_PATH=//home/ubuntu/raisin/repo2/src/raisin
...
export NEW_RELIC_CONFIG_FILE=/home/ubuntu/raisin/repo2/src/newrelic.ini
exec  /home/ubuntu/raisin/repo2/src/raisin/bin/newrelic-admin  run-program $VIRTUAL_ENV_PATH/bin/gunicorn ${DJANGO_WSGI_MODULE}:application --name $NAME --workers $NUM_WORKERS --user=$USER --group=$GROUP --bind unix:$SOCKFILE --log-level=debug --log-file=$LOG_FILE --timeout 100 --limit-request-line $LIMIT_REQUEST_LINE
