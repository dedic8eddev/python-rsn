...
init.push(function () {
    b_datatable = $('#jq-datatables-example').DataTable({
        ...
        columns: [
            ...
            { "data" : "news_img_html", orderable: false },
...
//            var total_records = b_datatable.fnSettings().fnRecordsTotal();
           ...
           $('#jq-datatables-example_wrapper .table-caption').html('News: ' + total_records);
    ...
    $("#ui-bootbox-publish-confirm").click(function(){
        massOperationPipeline(url_news_publish_ajax, 'posts');
    });
    ...
    $("#ui-bootbox-merge-confirm").click(function(){
        massOperationPipeline(url_news_merge_ajax, 'posts');
    });
    ...
    $("#ui-bootbox-unpublish-confirm").click(function(){
        massOperationPipeline(url_news_unpublish_ajax, 'posts');
    });
    ...
    $("#ui-bootbox-delete-confirm").click(function(){
        massOperationPipeline(url_news_delete_ajax, 'posts');
    });
