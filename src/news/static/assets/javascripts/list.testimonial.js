...
init.push(function () {
    b_datatable = $('#jq-datatables-example').DataTable({
        ...
        columns: [
            ...
            { "data" : "testimonial_img_html", orderable: false },
            { "data" : "date", orderable: true },
            { "data" : "author_img_html", orderable: false },
            { "data" : "testimonial", orderable: true },
...
//            var total_records = b_datatable.fnSettings().fnRecordsTotal();
           ...
           $('#jq-datatables-example_wrapper .table-caption').html("Venues' Testimonials: " + total_records);
    ...
    $("#ui-bootbox-publish-confirm").click(function(){
        massOperationPipeline(url_testimonial_publish_ajax, 'posts');
    });
    ...
    $("#ui-bootbox-unpublish-confirm").click(function(){
        massOperationPipeline(url_testimonial_unpublish_ajax, 'posts');
    });
    ...
    $("#ui-bootbox-delete-confirm").click(function(){
        massOperationPipeline(url_testimonial_delete_ajax, 'posts');
    });
