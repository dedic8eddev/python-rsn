...
init.push(function () {
    b_datatable = $('#jq-datatables-example').DataTable({
        ...
        columns: [
            ...
            { "data" : "cheffe_img_html", orderable: false },
            { "data" : "date", orderable: true },
            { "data" : "author_img_html", orderable: false },
            { "data" : "cheffe", orderable: true },
...
//            var total_records = b_datatable.fnSettings().fnRecordsTotal();
           ...
           $('#jq-datatables-example_wrapper .table-caption').html("Venues' Cheffes: " + total_records);
    ...
    $("#ui-bootbox-publish-confirm").click(function(){
        massOperationPipeline(url_cheffe_publish_ajax, 'posts');
    });
    ...
    $("#ui-bootbox-unpublish-confirm").click(function(){
        massOperationPipeline(url_cheffe_unpublish_ajax, 'posts');
    });
    ...
    $("#ui-bootbox-delete-confirm").click(function(){
        massOperationPipeline(url_cheffe_delete_ajax, 'posts');
    });
