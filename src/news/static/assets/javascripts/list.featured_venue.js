...
init.push(function () {
    b_datatable = $('#jq-datatables-example').DataTable({
        ...
        columns: [
            ...
            { "data" : "featured_venue_img_html", orderable: false },
...
//            var total_records = b_datatable.fnSettings().fnRecordsTotal();
           ...
           $('#jq-datatables-example_wrapper .table-caption').html('Featured Venue: ' + total_records);
    ...
    $("#ui-bootbox-publish-confirm").click(function(){
        massOperationPipeline(url_featured_venue_publish_ajax, 'posts');
    });
    ...
    $("#ui-bootbox-merge-confirm").click(function(){
        massOperationPipeline(url_featured_venue_merge_ajax, 'posts');
    });
    ...
    $("#ui-bootbox-unpublish-confirm").click(function(){
        massOperationPipeline(url_featured_venue_unpublish_ajax, 'posts');
    });
    ...
    $("#ui-bootbox-delete-confirm").click(function(){
        massOperationPipeline(url_featured_venue_delete_ajax, 'posts');
    });
